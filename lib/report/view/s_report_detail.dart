...
class _ReportDetailState extends ConsumerState<ReportDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultLayout(
        ...
        child: Center(
          child: FutureBuilder(
            future: ReportDetailService()
                .show(conversationId: ref.watch(chatIdProvider)),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const CircularProgressIndicator();
              } else if (snapshot.hasError) {
                return const Text('레포트를 불러오지 못했습니다.'); // 에러 발생 시 표시
              } else if (snapshot.hasData) {
                final result = snapshot.data as ReportDetailModel;
                              ...
                              child: ListView(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: EmotionCard(
                                        emotionPercentage: result
                                            .emotions!.comfortablePercentage!,
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      '일기 전체보기',
                                      style:
                                          FontSizes.getHighLightContentStyle(),
                                    ),
                                  ),
                                ),
                                Padding(
                                ...
                                ? Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: List.generate(
                                        ...
                                        if (result.chatHistory![index].role ==
                                            "ai") {
                                          return Text(
